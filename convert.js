...
(() => {
  ...
  function buildDns({
    ...
    const defaults = fakeIPEnabled ? buildDnsConfig({ mode: "fake-ip", ipv6Enabled, fakeIpFilter: FAKE_IP_FILTER }) : buildDnsConfig({ mode: "redir-host", ipv6Enabled });
    const config = {
      ...defaults,
      ...source,
      ipv6: ipv6Enabled,
  ...
  var FAKE_IP_FILTER, snifferConfig, DOGGYGO_SERVER_DOMAINS;
  var init_dns = __esm({
    "src/dns.ts"() {
      "use strict";
      FAKE_IP_FILTER = [
